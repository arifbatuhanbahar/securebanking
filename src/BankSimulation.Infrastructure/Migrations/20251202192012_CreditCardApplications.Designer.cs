...
namespace BankSimulation.Infrastructure.Migrations
{
    ...
    [Migration("20251202192012_CreditCardApplications")]
    partial class CreditCardApplications
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.Audit.AuditLog", b =>
                {
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.Audit.DataAccessLog", b =>
                {
                    b.Property<int>("LogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("AccessTimestamp")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasColumnName("access_timestamp")
                        .HasDefaultValueSql("GETDATE()");
                    ...
                    b.ToTable("data_access_log", (string)null);
                });

            modelBuilder.Entity("BankSimulation.Domain.Entities.Audit.EncryptionKey", b =>
                {
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.Audit.PciAuditLog", b =>
                {
                    b.Property<int>("LogId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("pci_audit_log", (string)null);
                });

            modelBuilder.Entity("BankSimulation.Domain.Entities.Audit.SecurityEvent", b =>
                {
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.Compliance.KvkkConsent", b =>
                {
                    ...
                    b.ToTable("kvkk_consents", (string)null);
                });

            modelBuilder.Entity("BankSimulation.Domain.Entities.Compliance.KvkkDataRequest", b =>
                {
                    ...
                    b.Property<string>("ResponseFilePath")
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)")
                        .HasColumnName("response_file_path");
                    ...
                    b.ToTable("kvkk_data_requests", (string)null);
                });

            modelBuilder.Entity("BankSimulation.Domain.Entities.Compliance.KycDocument", b =>
                {
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.Compliance.KycVerification", b =>
                {
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.Compliance.MasakRecord", b =>
                {
                    ...
                    b.ToTable("masak_records", (string)null);
                });

            modelBuilder.Entity("BankSimulation.Domain.Entities.Compliance.SuspiciousActivityReport", b =>
                {
                    b.Property<int>("SarId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("sar_id");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("SarId"));
                    ...
                    b.Property<string>("MasakReferenceNumber")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasColumnName("masak_reference_number");
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.Fraud.FraudRule", b =>
                {
                    ...
                    b.Property<int>("RiskScoreWeight")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0)
                        .HasColumnName("risk_score_weight");

                    b.Property<string>("RuleConditions")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("rule_conditions");
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.Fraud.RiskProfile", b =>
                {
                    ...
                    b.Property<int>("AmountAnomalyScore")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0)
                        .HasColumnName("amount_anomaly_score");
                    ...
                    b.Property<int>("GeographicRiskScore")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0)
                        .HasColumnName("geographic_risk_score");
                    ...
                    b.Property<int>("TransactionVelocityScore")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0)
                        .HasColumnName("transaction_velocity_score");
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.PaymentAndCards.CardTransaction", b =>
                {
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.PaymentAndCards.PaymentGateway", b =>
                {
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.PaymentAndCards.PaymentMethod", b =>
                {
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.PaymentAndCards.RecurringPayment", b =>
                {
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.System.NotificationTemplate", b =>
                {
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.System.SystemSetting", b =>
                {
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.Audit.DataAccessLog", b =>
                {
                    b.HasOne("BankSimulation.Domain.Entities.UserManagement.User", "AccessedByUser")
                        .WithMany()
                        .HasForeignKey("AccessedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("BankSimulation.Domain.Entities.UserManagement.User", "TargetUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.Audit.SecurityEvent", b =>
                {
                    b.HasOne("BankSimulation.Domain.Entities.UserManagement.User", "ResolvedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.Compliance.KvkkDataRequest", b =>
                {
                    b.HasOne("BankSimulation.Domain.Entities.UserManagement.User", "CompletedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.Compliance.KycDocument", b =>
                {
                    ...
                    b.HasOne("BankSimulation.Domain.Entities.UserManagement.User", "VerifiedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.Compliance.MasakRecord", b =>
                {
                    b.HasOne("BankSimulation.Domain.Entities.UserManagement.User", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.PaymentAndCards.RecurringPayment", b =>
                {
                    b.HasOne("BankSimulation.Domain.Entities.PaymentAndCards.PaymentMethod", "PaymentMethod")
            ...
            modelBuilder.Entity("BankSimulation.Domain.Entities.System.SystemSetting", b =>
                {
                    b.HasOne("BankSimulation.Domain.Entities.UserManagement.User", "UpdatedByUser")
                        .WithMany()
